...
<body>
 ...
 <div id="main">
        <form method="GET" action="/KHBaseball/Board/WriteOk.do" >
        <table id="tblForm">
        <tr>
        	<th class="left">이름</th>
        	<td class="right"><input type="text" name="title" id="title" class="short" /></td>
        </tr>
        <tr>
        	<th class="left">제목</th>
        	<th class="right"><input type="text" name="subject" id="subject" class="long"></th>
        </tr>
        <tr>
			<th class="left">글내용</th>
			<td class="right"><textarea name="content" id="content" class="long" ></textarea></td>
		</tr>
        </table>
        <input type="button" value="글쓰기" style="cursor:pointer;" onclick="send();"/>
        </form>
