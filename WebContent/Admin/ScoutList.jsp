...
<script type="text/javascript" charset="utf-8">
	...
	function fsel(n) {
		...
		location.href = "/KHBaseball/Admin/ScoutList.do?teamdemerit=${teamdemerit}&team=" + n  + "&prSalary=" + val;
	}
	...
	function selPrSalary(prSalary) {
		 if (prSalary.value != "salary1") { 
		     var teamdemerit = document.getElementById("teamdemerit");
			 var val = prSalary.value;
			 location.href = "/KHBaseball/Admin/ScoutList.do?teamdemerit=" + teamdemerit.value + "&team=${team}&prSalary=" + val;
		 }
	 }
				...
				<div id="mainContent">
					...
					<div id="demerits">
						<form name="form1" id="form1">
							<a style="font-weight:bold; text-decoration: none;" > &nbsp;&nbsp;팀단점 : </a>
					...
					<div id="tabs">
						...
						<form method="GET" id="scoutForm" name="scoutForm" action="/KHBaseball/Admin/Scout.do">
