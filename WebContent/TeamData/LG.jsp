...
#tblTeam #td2{width:300px;height:200px;font-size: 15pt;}
#tblTeam #td3{width:300px;height:400px;font-size: 15pt;}
#logo{
   ...
   <div id="bg" style="background-color: #FFFAFA;">
      <div class="wrap" style="width:980px;">
         ...
         <div id="main">
            ...
            <p id="p1" style="font-size:20pt;margin-left: 185px;margin-top: 100px;">구단소개 ><span style="color:red;">LG</span></p>
               
             <table id="tblTeam" >
			<tr>
				<td id="td1"> <img src="../images/logo/Sk.jpg" id="logo" /> </td>
				<td id="td2">
				<p style="font-size:20pt;color:red;">LG 트윈스</p></br>  
				토론장 가기  </br>
				창단 : 1990년 </br>
				홈구장 : 잠실야구장 </br>
				우승 : 2회 우승 (90, 94) </br>
			...
			<tr>
				...
				<p style="font-size:20pt;">팀 컬러</p></br>
				...
				<img src= "../images/1.jpg" style="width:90px; height:120px;"/></br>
				감독: 백인천</br>
				코치: 이재환, 유백만</br>
