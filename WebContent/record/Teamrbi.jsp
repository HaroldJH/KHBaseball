      ...
      <div class="wrap">
         ...
         <div id="main">
           ...
           <table id="subTitle" border="1px solid gray">
            ...
            <h4 style="margin-bottom: 1px;margin-left: 185px;margin-top: 100px;font-size:20pt; ">팀별 평균 타점</h4>
		...
		<tr>
			<th id="col1">순위</th>
			<th id="col2">선수이름</th>
			<th id="col3">팀별 평균 타점</th> 
		</tr>
		<!-- 도루 -->
		<c:forEach items="${teamrbi}" var="dto">
		<tr>
			<td class="cell1">${dto.rnum}</td>
			<td class="cell2">${dto.teamName}</td>
			<td class="cell3">${dto.teamRbi}</td>
		</tr>
	</c:forEach>
