      ...
      <div class="wrap">
         ...
         <div id="main">
           ...
           <table id="subTitle" border="1px solid gray">
            ...
            <h4 style="margin-bottom: 1px;margin-left: 185px;margin-top: 100px;">타율 20명까지 순위</h4>
		...
		<!-- homerun -->
		<c:forEach items="${battingaverage}" var="dto">
		<tr>
			<td class="cell1">${dto.rnum}</td>
			<td class="cell2">${dto.playerName}(${dto.teamName})</td>
			<td class="cell3">${dto.battingaverage}</td>
